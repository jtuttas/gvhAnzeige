...
class GUI {
    ...
    refresh(dataObj) {
        if (dataObj) {
            let d = new Date();
            let i = 1;
            jquery_1.default("#content").empty();
            jquery_1.default("#station").text(dataObj[0].station);
            this.updateTimer();
            dataObj.forEach((element) => {
                if (i <= 4) {
                    ...
                    if (min > 0) {
                        ...
                        if (element.type == "Bus") {
                            jquery_1.default("#content").append('<div class="col-xs-4 col-sm-4 col-md-4"><img class="img-responsive myrow myimg" src="bus.png">' + element.type + " " + element.line + '</div>');
                        }
                        else {
                        ...
                        if (realtime) {
                            ...
                            jquery_1.default("#content").append('<div class="col-xs-2 col-sm-2 col-md-2 minute"><i>' + min + ' min</i></div>');
                        }
                        jquery_1.default("#content").append('</div>');
                        i++;
                    }
                }
            });
    ...
    disconnected() {
        jquery_1.default("#station").text("");
        jquery_1.default("#content").empty();
        jquery_1.default("#content").append('<div class="row">');
        jquery_1.default("#content").append('<div class="col-xs-12 col-sm-12 col-md-12 err"> <p>Verbindung zum Server verloren!!</p></div>');
        jquery_1.default("#content").append('</div>');
    }
}
exports.GUI = GUI;
...
jquery_1.default(() => {
    console.log("start..");
    wsc = new WSController_1.WSController(self.location.host);
});

},{"./WSController":2,"jquery":4}],4:[function(require,module,exports){
/*!
